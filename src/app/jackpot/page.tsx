...
const Jackpot = () => {
  ...
  const rows = [
    {
      Worker: (
        <div className="flex items-center justify-start rounded-[100px] bg-backgroundPrimary py-[4px] px-[6px] text-[16px] mmd:text-[20px] font-[500] text-success">
          <Image
            src="/worker_img.png"
            alt="Logo"
            width={20}
      ...
      cRank: (
        <div className="text-success text-[16px] mmd:text-[24px]">
          #315,739,255
        </div>
      ),
      Reward: (
        <div className="text-success flex justify-end items-center text-[16px] mmd:text-[32px]">
          4,722
    ...
    {
      Worker: (
        <div className="w-[105px] flex items-center rounded-[100px] bg-backgroundPrimary py-[4px] px-[6px] text-[16px] font-[500]">
          <Image
            src="/worker_img.png"
            alt="Logo"
            width={20}
      ...
      Reward: (
        <div className="flex justify-end items-center text-[16px]">
          4,722
          <EthLogoSvg
            className="w-[10px] h-[16px] ml-[4px] mmd:ml-[8px]"
            color="#fff"
          />
        </div>
      )
  ...
  return (
    <div>
      <TitlePage value={'JACKPOT'} />
      <div
        className={`${montserrat.className} w-full mx-auto max-w-[800px] min-w-[343px] rounded-[32px] bg-backgroundGray backdrop-blur-[16px]  font-[700]
             p-[20px] mmd:p-[32px]
             text-[16px] text-textSecondary`}
      >
        <div
          className="flex justify-between items-center mb-[32px] font-[700]
        ...
        <div className="block mmd:hidden">
          <div className="mb-[32px]">
            ...
            <div className="text-[40px] text-textPrimary">24 :59: 59</div>
          </div>
          <>
            <div className="mb-[8px]">Active Pot</div>
            <div className="flex items-center text-success text-[40px]">
              0.2322
              <EthLogoSvg className="ml-[12px] w-[32px] h-[32px]" />
            </div>
          </>
        ...
        <div className="hidden mmd:block font-[600]">
          <div className="flex justify-between items-center mb-[16px] mmd:mb-[20px]">
            ...
            <div className="text-[20px] text-textPrimary">
              323,23 / 315,739,255
            </div>
          </div>
          <div className="flex justify-between items-center mb-[16px] mmd:mb-[20px]">
        ...
        <div className="text-[14px] font-[400] leading-[18px] mb-[32px]">
          When the Fair mint ends, rewards from the vault are distributed to the
          last ten participating players as follows: the last player receives
          50% of the vault reward, while the remaining 50% is evenly split among
