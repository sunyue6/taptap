        ...
        ">
            ...
            ">
                ...
                <div className="text-[14px] font-[400] leading-[18px] mb-[32px]">
                    When the Fair mint ends, rewards from the vault are distributed to the last ten participating
                    players as
                    follows: the last player receives 50% of the vault reward, while the remaining 50% is evenly split
                    among
