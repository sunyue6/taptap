...
const SuccessSvg: React.FC<SvgProps>  = ({ className }) => (
    <div  className={className}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Frame" clipPath="url(#clip0_129_4637)">
                <path id="Vector"
                      ...
                      fill="#00FFB2" stroke="#00FFB2" strokeWidth="2" strokeLinejoin="round"/>
                <path id="Vector_2" d="M6.66663 10L9.16663 12.5L14.1666 7.5" stroke="#0C101B" strokeWidth="2"
                      strokeLinecap="round" strokeLinejoin="round"/>
            </g>
            <defs>
                <clipPath id="clip0_129_4637">
