...
const WarningSvg: React.FC<SvgProps>  = ({ className }) => (
    <div  className={className}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Frame" clipPath="url(#clip0_129_4679)">
                <path id="Vector"
                      ...
                      fill="#FFB62A" stroke="#FFB62A" strokeWidth="2" strokeLinejoin="round"/>
