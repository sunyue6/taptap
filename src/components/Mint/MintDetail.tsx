...
const MintDetail = () => {
  ...
  return (
    <div className="mx-auto w-full">
      <div
        className={`mx-auto ${montserrat.className} max-w-[800px] min-w-[343px] w-full rounded-[32px] bg-backgroundGray
                 backdrop-blur-[16px] p-[20px] mmd:p-[32px] text-[16px] leading-[18px] font-[600] text-textSecondary`}
      >
