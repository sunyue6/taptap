...
const FairMintTapTap = () => {
    ...
    return (
        <div className="z-50 mx-auto font-montserrat w-full px-4 md:px-16">
            <div
                ...
                <div className="flex justify-between items-center mb-[20px]">
                    ...
                    <input
                        ...
                        min="1"
                        max="100"
                        className="border border-textSecondary rounded-[8px] max-w-[148px] min-w-[100px] p-[12px] bg-transparent"/>
                </div>
                <div className="flex justify-between items-center mb-[20px]">
                    <div>Global Rank</div>
                    <div>111</div>
