...
const SwapInfo = () => {
  return (
    <div
      className={`relative mx-auto w-full ${montserrat.className} h-[444px] rounded-[32px] bg-[rgba(240,255,230,0.1)]
             backdrop-blur-[16px] p-[16px] text-[16px] leading-[18px] font-[600] text-textSecondary`}
    >
      ...
      <div className="rounded-[16px] bg-[rgba(240,255,230,0.1)] backdrop-blur-[16px] p-[16px] font-[500] text-[12px] mb-[4px]">
        ...
        <div className="flex justify-between items-center mb-[6px]">
          ...
          />
          <div>
            <div className="bg-backgroundPrimary rounded-full flex items-center justify-center h-[40px] leading-[40px] pl-[8px] pr-[12px] text-[20px]">
              <Image
                src="/logo_circle.png"
                alt="Logo"
                width={24}
        ...
        <div className="flex justify-between items-center text-textSecondary">
          ...
          <div>
            Balance:1.234{' '}
            <span className="text-success text-[14px] ml-[8px]">MAX</span>
          </div>
        </div>
      </div>
      <DownArrowSvg className="absolute left-1/2 transform -translate-x-1/2 top-[165px] z-10" />
      <div className="rounded-[16px] bg-[rgba(240,255,230,0.1)] backdrop-blur-[16px] p-[16px] font-[500] text-[12px]">
        <div className="mb-[4px]">Sell</div>
        <div className="flex justify-between items-center mb-[6px]">
      ...
      <div className="flex justify-between items-center text-[12px] mb-[16px] text-textPrimary">
        <div>
          ...
          <span className="text-backgroundThird ml-[10px]">($1.00)</span>
        </div>
