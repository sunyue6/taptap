...
const SwapChat = () => {
  ...
  return (
    <div
      className={`mx-auto ${montserrat.className} w-full min-w-[343px] mmd:min-w-[556px]  rounded-[32px] bg-backgroundSecondary 
        backdrop-blur-[16px] p-[16px] mmd:p-[32px] text-[16px] leading-[18px] font-[600] text-textSecondary`}
    >
      <div className="flex justify-between mb-[15px]">
        <div className="flex items-center text-[24px]">
          <Image
            ...
            width={35}
            height={35}
            className="mr-[8px] w-[35px] h-[35px]"
          />
