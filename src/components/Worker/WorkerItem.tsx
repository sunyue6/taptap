...
const WorkerItem = () => {
  ...
  return (
    <div
      className={`w-full mx-auto max-w-[800px] min-w-[343px] rounded-[32px] bg-backgroundGray backdrop-blur-[16px] ${montserrat.className} font-[700]
             p-[20px] mmd:p-[32px]
    ...
    >
      ...
      >
        ...
        <div onClick={handleToggle} className="cursor-pointer">
          {isUpSvg ? (
            <UpSvg className="w-[16px] h-[16px] mmd:w-[24px] mmd:h-[24px]" />
          ) : (
      ...
      {isUpSvg && (
        <div className="mt-[32px] font-[600]">
          ...
          <div className="flex justify-between items-center mb-[16px] mmd:mb-[20px]">
            <div>Total Estimated TAPTAP</div>
