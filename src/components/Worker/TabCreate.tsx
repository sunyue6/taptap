...
const TabCreate = () => {
  ...
  return (
    <div
      className={`
        w-full mx-auto max-w-[800px] min-w-[343px] rounded-[32px] bg-backgroundGray backdrop-blur-[16px] ${montserrat.className}
             p-[20px] mmd:p-[32px]
    ...
    >
      ...
      <div className="text-[14px] mb-[32px]">
        Worker provides batch FairMint services for smart contracts, supporting
        one-click Fair Mint, Claim Tap.
      </div>
